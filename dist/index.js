...
var ModelPricingSchema = import_zod3.z.object({
  ...
  /** Provider name */
  provider: import_zod3.z.enum(["google", "openai", "anthropic", "openrouter"]),
  /** Input token price per 1M tokens (USD) */
  inputPricePerMillion: import_zod3.z.number().nonnegative(),
  /** Output token price per 1M tokens (USD) */
  outputPricePerMillion: import_zod3.z.number().nonnegative(),
  /** Optional cached input price per 1M tokens */
  cachedInputPricePerMillion: import_zod3.z.number().nonnegative().optional(),
...
var TokenUsageSchema = import_zod3.z.object({
  ...
  cachedInputTokens: import_zod3.z.number().int().nonnegative().optional(),
